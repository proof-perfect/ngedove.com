...
function twentysixteen_scripts() {
	...
	wp_enqueue_script( 'Jquery', get_template_directory_uri() . '/bower_components/jquery/dist/jquery.js', array(), '20151112', true);

	wp_enqueue_script( 'Foundation What Input', get_template_directory_uri() . '/bower_components/what-input/what-input.js', array(), '20151112', true);

	wp_enqueue_script( 'Foundation', get_template_directory_uri() . '/bower_components/foundation-sites/dist/foundation.js', array(), '20151112', true);
	...
	wp_enqueue_script( 'Slick Js', get_template_directory_uri() . '/js/slick/slick.min.js', array(), '20151112', true);



	//Custom App Js

	wp_enqueue_script( 'App', get_template_directory_uri() . '/js/app.js', array(), '20151112', true);
